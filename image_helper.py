...
class ImageHelper(Helper):
    ...
    def load_data(self):
        ...
        self.advasarial_namelist = self.params['total_list']
    ...
    def add_pixel_pattern(self, ori_image, adversarial_index, test_type=None):
        ...
        if adversarial_index == -1:
            ...
            if adversarial_index < 4:
                ...
                poison_patterns = poison_patterns + self.params[str(adversarial_index % 4) + '_poison_pattern']
                poison_patterns = poison_patterns + self.params[
